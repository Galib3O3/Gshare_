...
function sendMail($email,$verify_code){
    ...
    try {
        ...
        $mail->Password   = 'jramlacpxb';                               //SMTP password
        ...
        <a href='http://localhost/g-share/landingpage/verify_mail.php?email=$email&v_code=$verify_code' style='display: inline-block; background-color: #4CAF50; color: white; padding: 10px 15px; text-align: center; text-decoration: none; border-radius: 4px; font-weight: bold;'>Verify Email</a>
