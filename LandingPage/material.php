...
<html lang="en">
   ...
   <body class="b-g">
                  ...
                  <div class="container-fluid ">
                     ...
                     <div class=" collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0  ">
                           ...
                           <li class="nav-item">
                              <a class="nav-link hv active" href="material.php">Files</a>
                           </li>
                           <li class="nav-item">
      ...
      <h1 class="d-flex mt-5 justify-content-center">G SHARE | MATERIALS</h1>
