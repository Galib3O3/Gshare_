   ...
   <body>
      <section class="pt-5">
         <div class="container">
            ...
            <div class="bg shadow rounded-lg d-block d-sm-flex mt-5">
               <div class="profile-tab-nav border-right">
                  <div class="p-4">
                     <div class="img-circle text-center mb-3">
                        <img class="mb-2" width ="100px" id="selectedImage" src="<?php echo $arraydata['image']?>"  alt="">
                        <h5>
                           <?php
                              if(isset( $_SESSION['l_uname'])){
               ...
               <div class="tab-content p-4 p-md-5" id="tabContent">
                  <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
                     ...
                     <div class="row">
                        ...
                        <h4 class="col-12 ms-3">Socail Media Handle</h4>
                        ...
                        <div class="col-md-6 col-lg-3">
                           <div class="form-group">
                              <label class="ms-3"> <i class="fa fa-github " style="font-size:20px"></i></span></label>
                      ...
                      <!-- for image upload -->
                           ...
                           <form action="UserimgUpload.php" method="post" enctype="multipart/form-data" class="form-inline">
                             <h3 class="col-12">Profile Image</h3>
                     ...
                     <form action="updateprofilepass.php" method="POST">
                        <div class="row">
                           ...
                           <div class="input-group">
                              <input type="checkbox" onclick="togglePassword()"> <span class="ms-2">Show Password</span>
                           </div>
                        </div>
                        <div>
