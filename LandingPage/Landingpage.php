...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="modalLoginform.css">
      <title>G SHARE</title>
   </head>
   <body class="container-md">
         ...
         <div class="row">
               ...
               <nav class="navbar  navbar-expand-lg  ">
                  <div class="container-fluid ">
                     ...
                     <div class=" collapse navbar-collapse" id="navbarSupportedContent">
                        <img class="img-fluid height "src="img/gshares.png" alt="">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0  ">
                           ...
                           <li class="nav-item">
                              <a class="nav-link hv " href="community.php">Community</a>
                           </li>
                           <li class="nav-item">
                           ...
                           <li>
                              <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                    <li id="bg"><span class="ms-3 pb-3"><i class="fa-regular fa-user pb-3"></i></span><a role="menuitem"  class="text-decoration-none text-black ps-3 mb-2" href="profilepage.php">Profile</a></li>
                                    <li id="bg"><span class="ms-3 pb-3"><i class="fa fa-dice-six pb-3"></i></span><a role="menuitem" class="text-decoration-none text-black ps-3 mb-2" href="userDashboard.php">Dashboard</a></li>
            ...
            <div class="row mb-4">
               <div class="col ">
                  ...
                  <p class="ms-5 text-black">A sharing website wheres you can find all of your things</p>
                  <a href="file.php" class="btn btn-outline-danger ms-5" id="shareBtn">Get Started</a>
               </div>
               <div class="col pe-1">
                  ...
                  <div class="accordion accordion-flush" id="accordionFlushExample">
                     <div class="accordion-item">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                           <div class="accordion-body">PlaAccess to a Wide Range of Course Materials: Our website serves as a hub where educators can upload and share their
                     ...
                     <div class="accordion-item">
                        <h2 class="accordion-header">
                           ...
                           Is this connect us with community
                           </button>
                        </h2>
      ...
      <footer class="text-center text-lg-start bg-light text-muted">
         ...
         <div class="text-center p-4 copyright text-white" >
            © 2023 Copyright:
            <a class="text-reset fw-bold text-decoration-none" href="">G SHARE |</a>
            <a class="text-reset fw-bold text-decoration-none" href="Admin/admin.php"> ADMIN</a>
         </div>
         <!-- Copyright -->
      </footer>
      <!-- Footer -->
